...
module.exports = {
    ...
    run: async(client, message, args) => {
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField(`<a:planeta:1071265646907773059> | Status hoje:`, `Vendas realizadas: ${hojepedidos || "0"} \nDinheiro arrecadado: R$ ${hojerecebimentos || "0"}`, false)
        .addField(`<a:planeta:1071265646907773059> | Status 7 dias:`, `Vendas realizadas: ${setedias || "0"} \nDinheiro arrecadado: R$ ${setediasrec || "0"}`, false)
        .addField(`<a:planeta:1071265646907773059> | Status 30 dias:`, `Vendas realizadas: ${setedias2 || "0"} \nDinheiro arrecadado: R$ ${setediasrec2 || "0"}`, false)
