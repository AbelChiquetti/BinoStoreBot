      ...
      const row = new Discord.MessageActionRow()
        .addComponents(
          new Discord.MessageButton()
            ...
            .setEmoji('<:MercadoPago:1066354092923965461>')
        ...
        .addComponents(
          new Discord.MessageButton()
            ...
            .setEmoji('<:settings:1066355265596837888>')
            .setLabel('Prefixo')
            .setStyle('SECONDARY'),
        )
        .addComponents(
          new Discord.MessageButton()
            ...
            .setEmoji('<a:yes:1066123518841999482>')
            .setLabel('Status')
            .setStyle('SECONDARY'),
        );
        ...
        const embed = await message.reply({ embeds: [new Discord.MessageEmbed()
          ...
          .setDescription(`
<:MercadoPago:1066354092923965461> | Token Mercado Pago: \`\Token Seguro\`
<:settings:1066355265596837888> | Prefixo: \`${config.get(`prefix`)}\`
<:staffgl:1066123429020971129> | Status do Bot: \`${config.get(`status`)}\``)
